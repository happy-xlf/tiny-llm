...
model_id = "F:\\llm_work\\tiny-llm\\output\\sft_model\\last_sft_model"

tokenizer = AutoTokenizer.from_pretrained(model_id, trust_remote_code=True)

model = AutoModelForCausalLM.from_pretrained(model_id, device_map="auto", config=AutoConfig.from_pretrained(model_id, trust_remote_code=True), trust_remote_code=True)
